...
![لافتة لغة الثعبان](docs/assets/brand-lockup.svg)
...
تعتمد صفحات `docs/` هوية لغة الثعبان: خط Montserrat بوزني Regular وBold، وخلفية عنوان داكنة `#111921`، ونص أبيض `#FFFFFF`، ولمسات بنفسجية `#2c1a66` وبرتقالية `#ea6753`. الشعار مولّد داخل الصفحات كعلامة هندسية دون أصول خارجية، مع إبقاء صفحات لغة الثعبان عربية أولاً ومباشرة نحو الملعب والأمثلة.
