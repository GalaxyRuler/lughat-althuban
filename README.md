...
<p align="center">
  <img src="docs/assets/ak-logo-noname.png" alt="شعار لغة الثعبان دون أسماء شخصية" width="260">
</p>
...
| [معرض GitHub Pages للأمثلة](docs/gallery.html) | أمثلة قابلة للفتح في الملعب، بما فيها ألعاب مرئية مثل قفزة المدينة وحارس الكويكبات وعروض stdlib وAI |
...
تعتمد صفحات `docs/` هوية لغة الثعبان: خط Montserrat بوزني Regular وBold، وخلفية عنوان داكنة `#111921`، ونص فاتح، ولمسات بنفسجية `#2c1a66` وبرتقالية `#ea6753`. تستخدم الصفحات ملف الشعار غير النصي `docs/assets/ak-logo-noname.png`، مع إبقاء صفحات لغة الثعبان عربية أولاً ومباشرة نحو الملعب والأمثلة.
