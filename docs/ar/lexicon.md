...
| ادوات_داليه | `functools` | `arabicpython/aliases/functools.toml` |
...
| تعابير_نمطيه | `re` | `arabicpython/aliases/re.toml` |
...
| مسار_مكتبه | `pathlib` | `arabicpython/aliases/pathlib.toml` |
| معرفات_فريده | `uuid` | `arabicpython/aliases/uuid.toml` |
| مكتبة_تاريخ | `datetime` | `arabicpython/aliases/datetime.toml` |
| ملفات_csv | `csv` | `arabicpython/aliases/csv.toml` |
| نصوص | `string` | `arabicpython/aliases/string.toml` |
| نظام | `sys` | `arabicpython/aliases/sys.toml` |
| نظام_تشغيل | `os` | `arabicpython/aliases/os.toml` |
| هاشلب | `hashlib` | `arabicpython/aliases/hashlib.toml` |
