...
**الحالة (2026-05-03)**: 2960 اختباراً ناجحاً في بيئة `.[all]` — المراحل أ/ب/ج مكتملة — عمل المرحلة د D-002 إلى D-005 مشحون، مع ملعب مرئي ولعبة منصة بواجهة Pygame عربية.
...
| البند | القيمة |
|-------|--------|
| الاختبارات | 2960 نجاحاً، 23 تخطياً مقصوداً خاصاً بإصدار Python أو مقتطفات غير قابلة للتشغيل |
...
- [معرض الأمثلة والملعب](../gallery.html)
